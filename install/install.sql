...
CREATE TABLE `bingo_admins` ( `id` INT UNSIGNED NOT NULL AUTO_INCREMENT , `username` VARCHAR(64) NOT NULL , `password` VARCHAR(128) NOT NULL , `salt` VARCHAR(32) NOT NULL , PRIMARY KEY (`id`), INDEX `idx_username` (`username`)) ENGINE = InnoDB;
